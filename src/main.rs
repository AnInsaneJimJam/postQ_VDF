use winterfell::{
    math::{fields::{f128::BaseElement as Felt, f62::BaseElement}, polynom::degree_of, FieldElement}, Air, AirContext, Assertion, ByteWriter, EvaluationFrame, FieldExtension, HashFunction, ProofOptions, Prover, Serializable, StarkProof, TransitionConstraintGroup, Trace, TraceInfo, TraceTable, TransitionConstraintDegree
};
...
pub fn main() {
    ...
    let stark_params = ProofOptions::new(40, 4, 21, HashFunction::Blake3_256, FieldExtension::None, 8, 64);
